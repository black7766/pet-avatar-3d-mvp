...
> 2026-07-11 更新：本文件记录第一轮默认参数对比。完成 69 组参数扫测和商用/软 alpha/人工毛发约束后，生产结论已更新为“自研绿幕 `core_despill=1.10` 主链 + BiRefNet General 异常后备”。最新结论见 `MATTING_PARAMETER_TUNING_20260711.md`，其优先级高于本文件。
